...
const required = [
  ...
  "spark-flood", "crawler flood, excluded from totals", "Human vs crawler",
];
...
// exactly one of the two fixture sites has bot traffic.
if (html.split(`class="crawler-row"`).length - 1 !== 1) {
  throw new Error("Crawler callout should render for exactly the one flooded fixture site");
}
